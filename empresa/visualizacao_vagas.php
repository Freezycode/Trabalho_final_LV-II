  ...
  <section class="container mt-5">
    <div class="row">
      <div class="col-12 highlight-section">
        <h3 class="section-title"><i class="fas fa-clipboard-list"></i> Somente suas vagas </h3>
        <div class="row">
          <?php
          ...
          try {
              $stmt = $pdo->prepare("SELECT id_vagas, descricao, requisitos, remuneracao, usuarios_id_empresa_vaga FROM vagas WHERE usuarios_id_empresa_vaga = ?");
              ...
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                  ...
                  <div class="text-right">
                    ...
                    <a href="telaedit.php?vaga_id=<?= $vaga['id_vagas'] ?>" class="btn btn-primary">Vizualizar</a>
                  </div>
                </div>
              </div>
            </div>
